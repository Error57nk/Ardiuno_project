...
const char* ssid = "Joy"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "joydip96"; // Your Wifi password, in case you have open network comment the whole statement.
